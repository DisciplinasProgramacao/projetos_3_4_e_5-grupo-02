...
public class Cliente {
	...
	/**
	 * Chama o método avaliar(Cliente, int) de Midia, passando-o como parâmetro o
	 * cliente atual que está avaliando a mídia em questão, bem como a nota a ser
	 * inserida na avaliação.
	 * 
	 ...
	 * Se positivo, prossegue em chamar o método avaliar(Cliente, int) de Midia,
	 * passando-o como parâmetro o cliente atual que está avaliando a mídia, bem
	 * como a nota a ser inserida na avaliação.
	 * 
	 * @param midia      Mídia a ser avaliada
...
//            modoAvaliacao.avaliarMidia(midia, this, nota, comentario);
	...
	/**
	 * Filtra, dentre as listas de séries para ver e de séries já vistas, aquelas
	 * que possuem quantidade de episódios igual à selecionada
	 * 
	 ...
	 * presente na lista de séries para ver, a operação não é realizada.
	 *
	 ...
	 * resultado da impressão tela ao se passar um objeto da classe Cliente como
	 * parâmetro do método print().
	 *
	 ...
	 * resultado da comparação entre dois objetos. Para isso, realiza downcast para
	 * Cliente, possibilitando comparar os ids de Cliente de ambos objetos. Caso os
	 * ids sejam iguais, o método assegura que os dois objetos se tratam de um mesmo
	 * cliente.
	 * 
